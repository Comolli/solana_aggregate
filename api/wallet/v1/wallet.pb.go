...
func (x *TransferRequest) GetDstAddress() string {
	if x != nil {
		return x.DstAddress
	}
	return ""
...
func (x *TransferResponse) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *TransferCallback) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
func (x *TransferCallback) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
func (x *DepositCallback) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DepositCallback) ProtoMessage() {}

func (x *DepositCallback) ProtoReflect() protoreflect.Message {
	mi := &file_api_wallet_v1_wallet_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DepositCallback.ProtoReflect.Descriptor instead.
func (*DepositCallback) Descriptor() ([]byte, []int) {
	return file_api_wallet_v1_wallet_proto_rawDescGZIP(), []int{5}
}

func (x *DepositCallback) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *DepositCallback) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *DepositCallback) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *DepositCallback) GetHash() string {
	if x != nil {
		return x.Hash
	}
	return ""
...
var file_api_wallet_v1_wallet_proto_rawDesc = []byte{
	...
	0x40, 0x00, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0x31, 0x0a, 0x15, 0x43, 0x72,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x22, 0xa5, 0x01,
	...
	0x12, 0x28, 0x0a, 0x0b, 0x64, 0x73, 0x74, 0x5f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18,
	0x02, 0x20, 0x01, 0x28, 0x09, 0x42, 0x07, 0xfa, 0x42, 0x04, 0x72, 0x02, 0x10, 0x01, 0x52, 0x0a,
	0x64, 0x73, 0x74, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x21, 0x0a, 0x06, 0x61, 0x6d,
	0x6f, 0x75, 0x6e, 0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x42, 0x09, 0xfa, 0x42, 0x06, 0x32,
	0x04, 0x20, 0x00, 0x40, 0x00, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x26, 0x0a,
	...
	0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x26, 0x0a, 0x10, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x68, 0x61, 0x73,
	0x68, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x68, 0x61, 0x73, 0x68, 0x22, 0x45, 0x0a,
	...
	0x68, 0x61, 0x73, 0x68, 0x22, 0x6d, 0x0a, 0x0f, 0x44, 0x65, 0x70, 0x6f, 0x73, 0x69, 0x74, 0x43,
	0x61, 0x6c, 0x6c, 0x62, 0x61, 0x63, 0x6b, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e,
	...
	0x61, 0x73, 0x68, 0x32, 0xe8, 0x01, 0x0a, 0x06, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x12, 0x75,
	...
	0x1a, 0x20, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65,
	...
	0x61, 0x70, 0x69, 0x2f, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x64,
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x67, 0x0a, 0x08, 0x54, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65,
	0x72, 0x12, 0x1a, 0x2e, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x72,
	...
	0x02, 0x1c, 0x3a, 0x01, 0x2a, 0x22, 0x17, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x77, 0x61, 0x6c, 0x6c,
	0x65, 0x74, 0x2f, 0x76, 0x31, 0x2f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x66, 0x65, 0x72, 0x42, 0x3e,
	0x0a, 0x09, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2e, 0x76, 0x31, 0x50, 0x01, 0x5a, 0x21, 0x73,
	0x6f, 0x6c, 0x61, 0x6e, 0x61, 0x5f, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65, 0x2f,
	0x61, 0x70, 0x69, 0x2f, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2f, 0x76, 0x31, 0x3b, 0x76, 0x31,
	0xa2, 0x02, 0x0b, 0x41, 0x50, 0x49, 0x57, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x56, 0x31, 0x62, 0x06,
...
var file_api_wallet_v1_wallet_proto_goTypes = []any{
	...
	(*TransferCallback)(nil),      // 4: wallet.v1.TransferCallback
	(*DepositCallback)(nil),       // 5: wallet.v1.DepositCallback
}
var file_api_wallet_v1_wallet_proto_depIdxs = []int32{
	0, // 0: wallet.v1.Wallet.CreateAddress:input_type -> wallet.v1.CreateAddressRequest
	2, // 1: wallet.v1.Wallet.Transfer:input_type -> wallet.v1.TransferRequest
	1, // 2: wallet.v1.Wallet.CreateAddress:output_type -> wallet.v1.CreateAddressResponse
	3, // 3: wallet.v1.Wallet.Transfer:output_type -> wallet.v1.TransferResponse
